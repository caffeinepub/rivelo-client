...
type MobileView = "list" | SettingsSection;
...
// iOS-style group config for mobile list
const MOBILE_GROUPS = [
  {
    ...
    items: [
      {
        ...
        label: "Appearance",
        description: "Font size, accent color",
        icon: <Palette className="w-4 h-4" />,
        iconBg: "oklch(0.62 0.20 260)",
      },
      {
        id: "chat" as SettingsSection,
        label: "Chat",
        description: "Temperature, tokens, streaming",
        icon: <ChatIcon />,
        iconBg: "oklch(0.68 0.18 192)",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "system-prompts" as SettingsSection,
        label: "System Prompts",
        description: "Universal & preset prompts",
        icon: <PromptIcon />,
        iconBg: "oklch(0.62 0.18 330)",
      },
      {
        id: "api-keys" as SettingsSection,
        label: "API Keys",
        description: "OpenRouter keys & failover",
        icon: <Key className="w-4 h-4" />,
        iconBg: "oklch(0.65 0.18 55)",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: "Profile",
        description: "Switch profiles, sign out",
        icon: <User className="w-4 h-4" />,
        iconBg: "oklch(0.60 0.16 300)",
      },
      {
...
export default function SettingsPage({
  ...
  // Mobile: 'list' = show the iOS-style category list, any section = drill into it
  ...
  // The shared section content (used in both mobile drill-in and desktop right panel)
  function SectionContent({ s }: { s: SettingsSection }) {
    return (
              ...
              <div className="flex gap-2">
                {(["small", "medium", "large"] as const).map((sz) => (
                  <button
                    key={sz}
                    type="button"
                    data-ocid={`settings.font_size.${sz}.button`}
                    ...
                    style={{
                      background:
                        fontSize === sz
                          ...
                          : "oklch(var(--surface-2))",
                      color:
                        fontSize === sz ? "white" : "oklch(var(--foreground))",
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            toast.success(`${preset.name} prompt applied`);
                          }}
          ...
          <>
            ...
            >
              ...
              <p
                ...
                style={{ color: "oklch(var(--muted-foreground))" }}
              >
                A mobile-first OpenRouter client. All data is stored locally in
              ...
              <p
                ...
                style={{ color: "oklch(var(--muted-foreground))" }}
              >
                Supports 200+ AI models, multi-profile auth, API key failover,
                in-app code sandbox, and streaming responses.
              </p>
            </div>
        ...
        {mobileView === "list" ? (
          ...
          <>
            ...
            >
              <button
                type="button"
                data-ocid="settings.section.back.button"
              ...
              <h1
                ...
                style={{ color: "oklch(var(--foreground))" }}
              >
                {SECTION_LABELS[mobileView as SettingsSection]}
              </h1>
            </div>

            {/* Section content — scrollable */}
            <ScrollArea className="flex-1">
              <SectionContent s={mobileView as SettingsSection} />
            </ScrollArea>
          </>
        )}
      </div>
